    class Dijkstra {
        ...
        dijkstra(inicio: string, destino: string): { caminho: string[], distancia: number } {
    ...
    grafodijk.addAresta('Yukon', 'Northwest Territories', 1.108 );
    grafodijk.addAresta('Northwest Territories', 'Nunavut', 2.271);
    grafodijk.addAresta('British Columbia', 'Alberta', 689);
    grafodijk.addAresta('British Columbia', 'Yukon', 1.486);
    grafodijk.addAresta('British Columbia', 'Northwest Territories', 1.572);
    grafodijk.addAresta('Alberta', 'Northwest Territories', 1.263);
    grafodijk.addAresta('Alberta', 'Saskatchewan', 603);
    grafodijk.addAresta('Saskatchewan', 'Northwest Territories', 1.455);
    grafodijk.addAresta('Saskatchewan', 'Manitoba', 596);
    grafodijk.addAresta('Manitoba', 'Nunavut', 2.298);
    grafodijk.addAresta('Manitoba', 'Ontario', 1.507);
    grafodijk.addAresta('Ontario', 'Quebec', 508);
    grafodijk.addAresta('Quebec', 'New Brunswick', 708);
    grafodijk.addAresta('Quebec', 'Newfoundland and Labrador', 1.299);
    ...
    let resultado = grafodijk.dijkstra('Yukon', 'Alberta');
